...
# 1. 打开 DEM
tif_path = r"E:\code\geo_processing\database\testdata\0.61232.tif"
...
row_values = img[0,row_median-1,:]  #0表示第一波段
# 定义一个极小阈值，例如 -3e10
threshold = -3e10
# 判断首尾是否为异常值
...
# 2. 打开 CF
tif_path2 = r"E:\code\geo_processing\database\testdata\0.61232CFnodata0.tif"
...
row_values2 = img2[0,row_median2-1,:]  #0表示第一波段
# 判断首尾是否为异常值
...
col_values2 = img2[0, :, col_median2-1]
# 判断首尾是否为异常值
