...
with open(r"E:\code\geo_processing\database\zhangzhongjing1.tif") as dataset:
    width = dataset.width
    height = dataset.height

data = np.loadtxt(r"E:\code\geo_processing\database\zhangzhongjing1020.txt")
rows = len(data)

results = []
output_folder = r"E:\code\geo_processing\database\UnifiedProject2"
